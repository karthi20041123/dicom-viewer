  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.ok && data.success) {
        ...
        if (response.status === 400) errorMessage = 'Invalid input. Check your details.';
        if (response.status === 409) errorMessage = 'Email or username already exists.';
